...
if (isset($_POST['submit'])) {
    ...
    if (
        ...
        !preg_match("/[!@#$%^&*(),.?;:{}|<>]/", $password) // Symbol check
    ) {
        ...
        if (mysqli_stmt_num_rows($stmt) > 0) {
            ...
            if ($password === $cpassword) {
                ...
                $insert = mysqli_query($connection, "INSERT INTO `users` (firstname, surname, email, password) VALUES('$firstname', '$surname', '$email', '$password_hash')");
...
<section class="section " id="home" aria-label="home">
    ...
    <input type="text" name="firstname" placeholder="Firstname" class="login-field" required>
   
    <input type="text" name="surname" placeholder="Surname" class="login-field" required>
    ...
    <input type="password" name="confirmpassword" placeholder="Confirm Password" class="login-field" required>
   
    <input type="submit" name="submit" placeholder="egister" class="login-button" >
